...
class VoxtralForConditionalGeneration(VoxtralPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        audio_embed_mask: Optional[torch.Tensor] = None,
        attention_mask: Optional[torch.Tensor] = None,
        ...
        **kwargs,
        ...
        if input_features is not None:
            ...
            #TODO: [modified] replace text-audio token placeholders with audio embeddings
            inputs_embeds[audio_token_mask] = audio_embeds[audio_embed_mask.view(-1)]
    ...
    def prepare_inputs_for_generation(self, *args, **kwargs):
        ...
        audio_embed_mask = kwargs.pop("audio_embed_mask", None)
        ...
        if cache_position is not None and cache_position[0] == 0:
            ...
            model_inputs["audio_embed_mask"] = audio_embed_mask
