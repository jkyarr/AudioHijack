    ...
    def encode_audios(self, audios):
        ...
        for audio in audios:
            if isinstance(audio, dict):
                audio_data, speech_prompt = audio['audio_data'], audio['speech_prompt']
            ...
            gumbel_onehot = gumbel_softmax(-distance, tau=10.0, hard=True)
    ...
    def pack_input(self, text_inputs, audio_inputs, labels, mode):
        ...
        for i, input_id in enumerate(input_ids):
            ...
            if len(user_token_idx) > 0 and len(assist_token_idx) > 0:
                ...
                input_mask[i, assist_token_idx[-1]+3:] = 4 # target index mask: 4
